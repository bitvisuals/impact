...
(function () {
	...
	LoginModule = {
		...
		// Config
		id : "loginmodule", // Same as in the stylesheet file
		applicationController : window.Application, // Shortcut to owner
		acceptsDatatype : null, // Set the filetype if any (null is valid)
		usesServices: [], // List of services used by this module (can be empty)
		...
		moduleWillShow : function (data) {
			...
			HTMLOutput = '<section id=' + this.id + '><p>LOGIN</p><span id="login-done" class="back-button" style="display:block;">Done</span></section>';
		...
		addEventListeners : function() {
			$('#login-done').tap(function(e) {
				this.applicationController.dismissPushedModule(this.id);
			}.bind(this));
		},
